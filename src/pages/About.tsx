...
const About = () => {
  ...
  const values = [{
    ...
    icon: Building,
    title: 'About Us',
    description: 'A.G. Health Industries Pvt. Ltd. is a leading manufacturer of premium hygiene products in Nepal. With state-of-the-art ISO-certified facilities and a dedicated team of professionals, we produce high-quality sanitary pads, baby diapers, and other essential hygiene products that meet international standards while remaining accessible to all.'
  }];
  const principles = [{
