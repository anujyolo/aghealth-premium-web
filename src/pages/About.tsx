          ...
          <Card className="border-0 shadow-soft hover:shadow-medium transition-smooth bg-white/10 backdrop-blur-sm animate-fade-in max-w-5xl mx-auto">
            <CardContent className="p-8 md:p-12 space-y-8">
              <div className="flex items-center space-x-4">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-amber-100">About Us</h2>
              </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            {values.map((value, index) => <Card key={value.title} className="border-0 shadow-soft hover:shadow-medium transition-smooth bg-white/10 backdrop-blur-sm animate-fade-in" style={{
            animationDelay: `${index * 150}ms`
                ...
                <CardContent className="p-8 space-y-6">
                  ...
                  <h2 className="text-3xl font-bold text-amber-100">{value.title}</h2>
      ...
      <section className="py-16 md:py-20 bg-black/40 backdrop-blur-sm">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {principles.map((principle, index) => <Card key={principle.title} className="border-0 shadow-soft hover:shadow-medium transition-smooth bg-white/10 backdrop-blur-sm group animate-fade-in" style={{
            animationDelay: `${index * 100}ms`
          }}>
