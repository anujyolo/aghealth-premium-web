        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              ...
              <a href="https://www.linkedin.com/company/ag-health-industries-pvt-ltd/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-primary/10 hover:bg-primary flex items-center justify-center transition-smooth group" aria-label="LinkedIn">
                <Linkedin className="w-4 h-4 text-primary group-hover:text-white transition-smooth" />
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-primary/10 hover:bg-primary flex items-center justify-center transition-smooth group" aria-label="X (Twitter)">
                <svg className="w-4 h-4 text-primary group-hover:text-white transition-smooth" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-primary/10 hover:bg-primary flex items-center justify-center transition-smooth group" aria-label="Reddit">
                <svg className="w-4 h-4 text-primary group-hover:text-white transition-smooth" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+9771234567890" className="text-muted-foreground hover:text-primary transition-smooth text-sm">+977 9801116956</a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="mailto:kripa.ad25@gmail.com" className="text-muted-foreground hover:text-primary transition-smooth text-sm">
